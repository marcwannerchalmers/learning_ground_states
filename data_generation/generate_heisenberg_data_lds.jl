...
function main()
    ...
    nsweeps = 500
    minsweeps = 5
    basepath = "learning_ground_states/final_data/unif_LDS/"
    path_j = "learning_ground_states/lds_sequences/lds_$(Lx)x$(Ly).txt"
    J_lds = CSV.read(path_j, DataFrame, header=false)
    J_lds = Matrix(J_lds)
